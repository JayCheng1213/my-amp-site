    ...
    >
      <div class="flex items-center justify-between mb-6 md:mb-8 pb-4 border-b border-dashed" :class="[theme === 'light' ? 'border-stone-200' : 'border-zinc-800']">
        <div>
          ...
          <p class="text-[10px] md:text-[11px] text-zinc-500 mt-0.5">STAGE 01 TO 05: UNIFIED CHASSIS AND POWER ISOLATION LAYOUT</p>
        </div>
      ...
      <!-- 橫向捲動容器 (overflow-x-auto) -->
      <div class="overflow-x-auto pb-2 custom-scrollbar">
        <!-- 強制設定最小寬度 min-w-[900px]，保護 SVG 比例不被手機擠壓 -->
        <div 
          :class="[theme === 'light' ? 'border-stone-300 bg-stone-50/30' : 'border-zinc-800 bg-zinc-950/30']"
          class="border rounded-xl overflow-hidden relative flex flex-col min-w-[900px]"
        >
          <!-- SVG 取消了 hidden md:block，現在手機版也能看見了 -->
          <svg class="absolute inset-0 w-full h-full pointer-events-none z-0" viewBox="0 0 1000 660" preserveAspectRatio="none">
            ...
            <text x="250" y="105" class="text-xs font-bold fill-sky-500" text-anchor="middle">USB</text>
            ...
            <text x="750" y="190" class="text-xs font-bold fill-orange-500" text-anchor="middle">IEM CABLE</text>
            
            <path d="M 680 455 L 820 455" class="signal-power" fill="none" stroke-width="3" stroke-linecap="round" />
            <text x="750" y="445" class="text-xs font-bold fill-orange-500" text-anchor="middle">SPK CABLE</text>
          </svg>

          <!-- 元件網格 (強制為 4 欄，取消手機版單欄堆疊) -->
          <div class="grid grid-cols-4 min-h-[520px] relative z-10">
            
            <div 
              :class="[theme === 'light' ? 'border-stone-200 text-stone-400' : 'border-zinc-800 text-zinc-600']"
              class="p-6 flex flex-col border-r border-dashed"
            >
              <div class="mb-4">
              ...
              <div class="flex-grow grid grid-rows-5 gap-y-2 pb-2">
                <div class="row-start-1 flex flex-col items-center justify-center bg-transparent">
                  ...
                  <svg viewBox="0 0 100 80" class="w-full h-16 stroke-current fill-none stroke-2 mt-1 bg-transparent" :class="[theme === 'light' ? 'text-stone-700' : 'text-zinc-300']">
            ...
            <div 
              :class="[theme === 'light' ? 'border-stone-200 text-stone-400' : 'border-zinc-800 text-zinc-600']"
              class="p-6 flex flex-col border-r border-dashed z-10"
            >
              <div class="mb-4">
          ...
          <div 
            :class="[theme === 'light' ? 'text-stone-400' : 'text-zinc-600']"
            class="p-6 min-h-[140px] flex flex-col relative z-10"
          >
            <div class="flex-grow flex flex-col items-center justify-center pt-2 bg-transparent">
